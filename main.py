...
with open('fasta_to_tabular.ga', 'r') as wf_file:
    workflow_json = json.load(wf_file)
    workflow_dict = gi.workflows.import_workflow_dict(workflow_json)
    workflow_id = workflow_dict['id']
    print("Workflow imported. ID:", workflow_id)


 
# # Import the workflow JSON file
# with open('fasta_to_tabular.ga', 'r') as wf_file:
#     workflow_dict = gi.workflows.import_workflow_json(wf_file.read())
#     workflow_id = workflow_dict['id']
#     print("Workflow imported. ID:", workflow_id)
